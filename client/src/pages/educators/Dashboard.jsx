...
const Dashboard = () => {
  ...
  return dashboardData ?  (
    <div className='min-h-screen flex flex-col justify-start gap-8 md:p-8 p-4 md:pb-0 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap items-center gap-5'>
         <div className='flex items-center gap-3 shadow-custom-card border border-blue-500 rounded-md w-56 p-4'>
      ...
      <div>
        <h2 className='text-lg font-medium pb-2'>Latest Enrollments</h2>
