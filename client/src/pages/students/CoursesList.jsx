  ...
  return (
    <>
      <div className='relative md:px-36 px-8 pt-20 text-left'>
        ...
        {filteredCourses.length === 0 && <div className=' text-center h-50 flex flex-col items-center justify-start gap-3'>
          <h1 className='text-3xl font-semibold'>No Courses Found</h1> 
          <p className='text-gray-500 text-medium'>Try adjusting your search criteria or filters.</p>
          </div>}
